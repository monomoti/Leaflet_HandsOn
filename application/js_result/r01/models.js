define(["jquery","underscore","backbone","apputil"],function($,_,Backbone,apputil){
    ...
    var PointGJModel = Backbone.Model.extend({
        ...
        saveAsGeoJSON:function(){            
            ...
            var that = this;
            postToServer("../update/points/",{saveData:data},function(data){that.dataSaved(data)},this.dataSaveFailed);
        },
        toGeoJSON:function(){
   ...
   var RouteGJModel = Backbone.Model.extend({
       ...
       saveAsGeoJSON:function(){            
           var data = JSON.stringify(this.toGeoJSON());
           var that = this;
           postToServer("../update/lines/",{saveData:data},function(data){that.dataSaved(data)},this.dataSaveFailed);
       },
       toGeoJSON:function(){
           var rtn = { "type": "FeatureCollection","features":[]};
           this.get("features").each(function(m){
   ...
   var AreaGJModel = Backbone.Model.extend({
       ...
       saveAsGeoJSON:function(){            
           var data = JSON.stringify(this.toGeoJSON());
           var that = this;
           postToServer("../update/areas/",{saveData:data},function(data){that.dataSaved(data)},this.dataSaveFailed);
       },
       toGeoJSON:function(){
           var rtn = { "type": "FeatureCollection","features":[]};
           this.get("features").each(function(m){
